...
``` r
instacart_top_10_aisle = instacart %>%
...
outlier in this dataset, they are data from day24 and day31. It should
...
This person’s activities shows weekly periodic, for example, the total
activities on every Tuesday approximately the same.This phenomenon is
more obvious during weekday. The total activities on weekends fluctuate
more,like the first Saturday is 631k, and the second Saturday drops to
422k.
